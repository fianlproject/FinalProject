...
<body>
	...
	<form name="pr_update" method="post"
		...
		<table width=80% cellspacing=0 cellpadding=3 align=center>
			...
			<tr>
				<td>사진삭제<input type="checkbox" name="deletephoto"
					value="deletephoto">
				</td>
			</tr>
					...
					<div class="content-inner">
						...
						<form enctype="multipart/form-data" name="pr_write" method="post"
							...
							<input type="hidden" id="longitude" name="longitude"> <input
								...
								type="hidden" name="uppr_photo" value="${pr_photo }"> <input
								type="hidden" name="pr_nowskill" value="${pr_nowskill }">
								...
								<div id="sm-group">
									<div class="input-group">
										<input autocomplete="off" class="form-control" id="datepicker"
											name="pr_end" required="required" type="text"
											value="${pr_end }"><span class="input-group-addon">일</span>
									</div>
								...
								<div id="sm-group">
									<div class="input-group">
										<input autocomplete="off" class="form-control" id="pr_exday"
											name="pr_exday" required="required" type="text"
											value="${pr_exday }"><span class="input-group-addon">일</span>
									</div>
								...
								<div id="sm-group">
									<div class="input-group">
										<input autocomplete="off" class="form-control" id="pr_needman"
											name="pr_needman" required="required" type="text"
											value="${pr_needman }"> <span
