			...
			<div class="content">
				<div class="content-header">
					<h3 class="header-text">
						프로젝트 필요 기술 <small class="small-text">프로젝트에 필요한 기술을 선택해주세요.</small>
					</h3>
					현재 등록되어 있는 기술은 ${pr_nowskill } 입니다
				</div>
				<div class="content-header">
					<form method="post" action="/pfinal/pfinal.do">
						<input type="hidden" name="command" value="Pr_SkillUpdateProc" />
						...
						<hr/>
						<div class="form-group">
							<input type="submit" value="수정" class="btn btn-lg btn-client js-disable-on-click btn-submit">
