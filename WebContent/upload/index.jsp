...
function addInputBox() {
 ...
 var addStr = "<tr><td width=40><input type=checkbox name=checkList value="+addCount+" size=40 ></td><td width=140><input type=file name=uploadname"+addCount+" size=40></td></tr>";
...
<form name="gForm" action="/pfinal/upload.do" enctype="multipart/form-data" method="post" >
