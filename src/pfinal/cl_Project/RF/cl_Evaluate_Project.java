...
public class cl_Evaluate_Project implements Command {
...
//		pr_id = pr_id_result[0];
		...
		String sql = "select pr_id, fr_id, cl_id, fin_price, start_day, end_day,"
					+ "fr_evaluate, fr_pr_comment, pr_status, pr_subject, (to_days(end_day)-to_days(start_day))as total"
...
//			pstmt.setInt(1, pr_id);
		...
		return "cl_pr_running_finish/cl_Evaluate_Project.jsp";
	}
