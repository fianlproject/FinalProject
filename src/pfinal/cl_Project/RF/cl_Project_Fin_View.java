...
public class cl_Project_Fin_View implements Command {
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			sql = "select fr_pr_comment, pr_subject, start_day, fin_price, fr_id,fr_evaluate, Floor((to_days(now())-to_days(start_day)))as total_day from runing_finish_project where pr_id="+pr_id;
